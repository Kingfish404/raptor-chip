...
trait MicroOP {
  ...
  def FP_NONE  = "000000"
  def FP_FMV_W_X = "000001"
  def FP_FMV_X_W = "000010"
  def FP_FSGNJ_S = "000011"
  def FP_FSGNJN_S = "000100"
  def FP_FSGNJX_S = "000101"
  def FP_FLW = "000110"
  def FP_FSW = "000111"
  def FP_FMV_D_X = "001000"
  def FP_FMV_X_D = "001001"
  def FP_FSGNJ_D = "001010"
  def FP_FSGNJN_D = "001011"
  def FP_FSGNJX_D = "001100"
  def FP_FLD = "001101"
  def FP_FSD = "001110"
  def FP_FADD_S = "001111"
  def FP_FSUB_S = "010000"
  def FP_FADD_D = "010001"
  def FP_FSUB_D = "010010"
  def FP_FMUL_S = "010011"
  def FP_FMUL_D = "010100"
  def FP_FMIN_S = "010101"
  def FP_FMAX_S = "010110"
  def FP_FMIN_D = "010111"
  def FP_FMAX_D = "011000"
  def FP_FLE_S = "011001"
  def FP_FLT_S = "011010"
  def FP_FEQ_S = "011011"
  def FP_FCLASS_S = "011100"
  def FP_FLE_D = "011101"
  def FP_FLT_D = "011110"
  def FP_FEQ_D = "011111"
  def FP_FCLASS_D = "100000"
  def FP_FCVT_W_S = "100001"
  def FP_FCVT_WU_S = "100010"
  def FP_FCVT_L_S = "100011"
  def FP_FCVT_LU_S = "100100"
  def FP_FCVT_S_W = "100101"
  def FP_FCVT_S_WU = "100110"
  def FP_FCVT_S_L = "100111"
  def FP_FCVT_S_LU = "101000"
  def FP_FCVT_W_D = "101001"
  def FP_FCVT_WU_D = "101010"
  def FP_FCVT_L_D = "101011"
  def FP_FCVT_LU_D = "101100"
  def FP_FCVT_D_W = "101101"
  def FP_FCVT_D_WU = "101110"
  def FP_FCVT_D_L = "101111"
  def FP_FCVT_D_LU = "110000"
  def FP_FCVT_S_D = "110001"
  def FP_FCVT_D_S = "110010"
  def FP_FMADD_S = "110011"
  def FP_FMADD_D = "110100"
  def FP_FMSUB_S = "110101"
  def FP_FMSUB_D = "110110"
  def FP_FNMSUB_S = "110111"
  def FP_FNMSUB_D = "111000"
  def FP_FNMADD_S = "111001"
  def FP_FNMADD_D = "111010"
  def FP_FDIV_S = "111011"
