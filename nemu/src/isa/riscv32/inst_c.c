...
#ifdef CONFIG_RV64
  INSTPAT("100 111???00 ??? 01", c.subw, A, { di = rtype(0b0100000, rs2, rs1, 0b000, rs1, 0b0111011); }); // rv64: subw
  INSTPAT("100 111???01 ??? 01", c.addw, A, { di = rtype(0b0000000, rs2, rs1, 0b000, rs1, 0b0111011); }); // rv64: addw
#else
