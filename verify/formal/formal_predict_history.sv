module formal_predict_history #(
  ...
  logic [GhrBits-1:0] fetch_ghr, decode_ghr, commit_ghr, query_ghr, snapshot_ghr;
  logic [PhrBits-1:0] fetch_phr, decode_phr, commit_phr, query_phr, snapshot_phr;
  ...
  logic [GhrBits-1:0] g[3], ng[3], snap_g;
  logic [PhrBits-1:0] p[3], np[3], snap_p;
  ...
  assign correct = fetch_ghr == g[0] && decode_ghr == g[1] && commit_ghr == g[2]
      ...
      && snapshot_ghr == snap_g && snapshot_phr == snap_p;
endmodule
