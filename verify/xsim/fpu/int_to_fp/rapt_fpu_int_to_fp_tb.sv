module rapt_fpu_int_to_fp_tb (
  ...
  rapt_fpu_int_to_fp #(
      ...
      .reset,
      .flush,
      .valid(valid && select == 0),
      .ready(unit_ready[0]),
      .operand,
      .unsigned_input,
      .rounding_mode,
      .result(unit_result[0]),
      .flags(unit_flags[0]),
      .result_valid(unit_valid[0])
  );
  rapt_fpu_int_to_fp #(
      .TARGET_DOUBLE(0),
      .INT64_INPUT(1)
  ...
  rapt_fpu_int_to_fp #(
      ...
      .reset,
      .flush,
      .valid(valid && select == 2),
      .ready(unit_ready[2]),
      .operand,
      .unsigned_input,
      .rounding_mode,
      .result(unit_result[2]),
      .flags(unit_flags[2]),
      .result_valid(unit_valid[2])
  );
  rapt_fpu_int_to_fp #(
      .TARGET_DOUBLE(1),
      .INT64_INPUT(1)
      ...
      .reset,
      .flush,
      .valid(valid && select == 3),
      .ready(unit_ready[3]),
      .operand,
      .unsigned_input,
      .rounding_mode,
      .result(unit_result[3]),
      .flags(unit_flags[3]),
      .result_valid(unit_valid[3])
  );
