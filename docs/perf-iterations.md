...
| current | 2ALU pMUL OoO LSU [9]   | 2869704 | 2530446 | 0.882 | 7e5,25 | 1e6,36    | 1e6, 51    | 9e4, 3 | 0e0, 0 | 1e6, 36   |
...
| current | 2ALU pMUL OoO LSU [9]   | 460943 | 339907 | 0.737 | 1e5,27 | 1e5,26    | 2e5, 46    | 2e4, 4 | 0e0, 0 | 2e5, 46   |
...
| ------- | --------------------- | --------: | ---------: | -------: | ---------: | ---------: | --------: | ----------: | -----------: | ---------: |
| current | 2ALU pMUL OoO LSU [9] |     76.01 | 915,409.21 | 9.82e-02 |      79.06 |  83,880.13 |  1.51e-02 |       29.70 | 4,836,589.92 |   6.61e-02 |

### RV64

| Commit  | Change                | NG45 Fmax |    NG45 Area | NG45 Pwr | ASAP7 Fmax | ASAP7 Area | ASAP7 Pwr | SKY130 Fmax |  SKY130 Area | SKY130 Pwr |
| ------- | --------------------- | --------: | -----------: | -------: | ---------: | ---------: | --------: | ----------: | -----------: | ---------: |
| current | 2ALU pMUL OoO LSU [9] |     46.67 | 1,531,961.83 | 1.11e-01 |      67.62 | 139,624.54 |  4.29e-03 |       21.02 | 8,115,397.06 |   1.04e-01 |

Footnote `[9]` matches the corresponding entry in the CoreMark/MicroBench tables above. Add a new row per commit when STA is re-run, mirroring the IPC tables so timing/area/power evolution can be tracked alongside performance.
