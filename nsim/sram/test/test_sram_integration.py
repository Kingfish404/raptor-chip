...
the *contract* between the four pieces of the integration:
  ...
  1. nsim/sram/configs/*.py           - macro shape definitions
  2. nsim/sram/wrappers/rapt_sram_blackbox.v - Yosys blackbox declarations
  3. nsim/sram/scripts/gen_stub_lib.py - placeholder Liberty/Verilog
  4. rtl_sv/memory/rapt_sram_1r1w.sv  - RTL macro instantiations
...
RTL_SRAM   = RAPTOR / "rtl_sv" / "memory" / "rapt_sram_1r1w.sv"
...
# ---------------------------------------------------------------------------
def test_configs():
    section("Configs (nsim/sram/configs/*_sky130.py)")
