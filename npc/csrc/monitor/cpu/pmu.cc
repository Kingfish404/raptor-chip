...
void perf_sample_per_cycle()
{
  ...
  // uint8_t l1i_state = *(uint8_t *)&(CONCAT(VERILOG_PREFIX, ifu__DOT__ifu_l1i__DOT__l1i_state));
  // bool l1i_cache_hit = *(uint8_t *)&(CONCAT(VERILOG_PREFIX, ifu__DOT__ifu_l1i__DOT__l1i_cache_hit));
