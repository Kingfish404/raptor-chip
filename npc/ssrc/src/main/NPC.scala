...
class ysyx_idu_decoder extends Module with Instr with MicroOP {
  ...
  val type_decoder = TruthTable(
    Map(
      ...
      LB____ -> BitPat("b" + "000000" + "10" + "0" + "0" +   "0001"), // I__
      LH____ -> BitPat("b" + "000000" + "10" + "0" + "0" +   "0001"), // I__
      LW____ -> BitPat("b" + "000000" + "10" + "0" + "0" +   "0011"), // I__
      LBU___ -> BitPat("b" + "000000" + "10" + "0" + "0" +   "0011"), // I__
      LHU___ -> BitPat("b" + "000000" + "10" + "0" + "0" +   "1111"), // I__
      SB____ -> BitPat("b" + "000000" + "01" + "0" + "0" +   "0001"), // S__
      SH____ -> BitPat("b" + "000000" + "01" + "0" + "0" +   "0011"), // S__
      SW____ -> BitPat("b" + "000000" + "01" + "0" + "0" +   "1111"), // S__
